...
\ud X_{it} & = (\alpha_i - \tfrac 1 2 e^{2 V_{it}}) \ud t + e^{V_{it}} \left(\rho_i \ud B_{it}^V + \sqrt{1 - \rho_i^2} \ud B_{it}^Z\right).
\end{aligned}
$$
...
\ud X_{0t} & = (\alpha_0 - \tfrac 1 2 e^{2 V_{0t}}) \ud t + e^{V_{0t}} \left(\rho_0 \ud B_{0 t}^Z + \sqrt{1 - \rho_0^2} \ud B_{0i}^\eta \right),
\end{aligned}
$$
